...
This project is just started, it is not complete, as the css class names are very logical and simple you can easily complete and intuitively guess the rest.
____
